...
typedef enum SANITIZER_CBID_DRIVER_API_enum {
   ...
   SANITIZER_CBID_DRIVER_API_cuKernelGetLibrary                                           = 754,
   SANITIZER_CBID_DRIVER_API_cuCtxRecordEvent                                             = 755,
   SANITIZER_CBID_DRIVER_API_cuCtxWaitEvent                                               = 756,
   SANITIZER_CBID_DRIVER_API_cuCtxCreate_v4                                               = 757,
   SANITIZER_CBID_DRIVER_API_cuGreenCtxStreamCreate                                       = 758,
   SANITIZER_CBID_DRIVER_API_cuStreamGetCtx_v2                                            = 759,
   SANITIZER_CBID_DRIVER_API_cuStreamGetCtx_v2_ptsz                                       = 760,
   SANITIZER_CBID_DRIVER_API_cuMemBatchDecompressAsync                                    = 761,
   SANITIZER_CBID_DRIVER_API_cuMemBatchDecompressAsync_ptsz                               = 762,
   SANITIZER_CBID_DRIVER_API_cuLogsRegisterCallback                                       = 763,
   SANITIZER_CBID_DRIVER_API_cuLogsUnregisterCallback                                     = 764,
   SANITIZER_CBID_DRIVER_API_cuLogsCurrent                                                = 765,
   SANITIZER_CBID_DRIVER_API_cuLogsDumpToFile                                             = 766,
   SANITIZER_CBID_DRIVER_API_cuLogsDumpToMemory                                           = 767,
   SANITIZER_CBID_DRIVER_API_cuCheckpointProcessGetRestoreThreadId                        = 768,
   SANITIZER_CBID_DRIVER_API_cuCheckpointProcessGetState                                  = 769,
   SANITIZER_CBID_DRIVER_API_cuCheckpointProcessLock                                      = 770,
   SANITIZER_CBID_DRIVER_API_cuCheckpointProcessCheckpoint                                = 771,
   SANITIZER_CBID_DRIVER_API_cuCheckpointProcessRestore                                   = 772,
   SANITIZER_CBID_DRIVER_API_cuCheckpointProcessUnlock                                    = 773,
   SANITIZER_CBID_DRIVER_API_cuStreamGetDevice                                            = 774,
   SANITIZER_CBID_DRIVER_API_cuStreamGetDevice_ptsz                                       = 775,
   SANITIZER_CBID_DRIVER_API_cuMemcpyBatchAsync                                           = 776,
   SANITIZER_CBID_DRIVER_API_cuMemcpyBatchAsync_ptsz                                      = 777,
   SANITIZER_CBID_DRIVER_API_cuMemcpy3DBatchAsync                                         = 778,
   SANITIZER_CBID_DRIVER_API_cuMemcpy3DBatchAsync_ptsz                                    = 779,
   SANITIZER_CBID_DRIVER_API_cuEventElapsedTime_v2                                        = 780,
   SANITIZER_CBID_DRIVER_API_cuTensorMapEncodeIm2colWide                                  = 781,
   SANITIZER_CBID_DRIVER_API_SIZE                                                         = 782,
