...
typedef enum SANITIZER_CBID_RUNTIME_API_enum {
    ...
    SANITIZER_CBID_RUNTIME_API_cudaGetDriverEntryPointByVersion                            = 468,
    SANITIZER_CBID_RUNTIME_API_cudaGetDriverEntryPointByVersion_ptsz                       = 469,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryLoadData                                         = 470,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryLoadFromFile                                     = 471,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryUnload                                           = 472,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryGetKernel                                        = 473,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryGetGlobal                                        = 474,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryGetManaged                                       = 475,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryGetUnifiedFunction                               = 476,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryGetKernelCount                                   = 477,
    SANITIZER_CBID_RUNTIME_API_cudaLibraryEnumerateKernels                                 = 478,
    SANITIZER_CBID_RUNTIME_API_cudaKernelSetAttributeForDevice                             = 479,
    SANITIZER_CBID_RUNTIME_API_SIZE                                                        = 480,
